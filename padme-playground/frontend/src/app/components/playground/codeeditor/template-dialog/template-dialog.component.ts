...
export class TemplateDialogComponent implements OnInit {
  ...
  public templates: Template[] =
    [
      ...
      {
        name: "RWorkshop", image: "assets/img/RWorkshop.svg", text: "R template for a Workshop", checked: false
      },
    ];
      ...
      if (template.checked) {
        ...
        switch (template.name) {
          ...
          case "PADME-Conductor":
            ...
            break;
          case "RWorkshop":
            createdTemplate = await this.CreateRWorkshopTemplate();
            break;
        }
        this.loading = false;
  ...
  /**
   * Fetches the template files for RWorkshop
   * @returns 
   */
  private async CreateRWorkshopTemplate(): Promise<EditorFile[]>
  {
    let prefix = "/assets/templates/RWorkshop";
