...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.HarborApi.ScannerRegistrationReq = factory(root.HarborApi.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The ScannerRegistrationReq model module.
   * @module model/ScannerRegistrationReq
   * @version 2.0
   */

  /**
   * Constructs a new <code>ScannerRegistrationReq</code>.
   * @alias module:model/ScannerRegistrationReq
   * @class
   */
  ...
  /**
   * Constructs a <code>ScannerRegistrationReq</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ScannerRegistrationReq} obj Optional instance to populate.
   * @return {module:model/ScannerRegistrationReq} The populated <code>ScannerRegistrationReq</code> instance.
   */
