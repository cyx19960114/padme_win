...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.HarborApi.PutRegistry = factory(root.HarborApi.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The PutRegistry model module.
   * @module model/PutRegistry
   * @version 2.0
   */

  /**
   * Constructs a new <code>PutRegistry</code>.
   * @alias module:model/PutRegistry
   * @class
   */
  ...
  /**
   * Constructs a <code>PutRegistry</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PutRegistry} obj Optional instance to populate.
   * @return {module:model/PutRegistry} The populated <code>PutRegistry</code> instance.
   */
