...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.HarborApi.ApiClient = factory(root.superagent, root.querystring);
  }
  ...
  var exports = function() {
     ...
     * @type {String}
     * @default http://localhost/api/v2.0
     */
    this.basePath = 'http://localhost/api/v2.0'.replace(/\/+$/, '');
  ...
  exports.prototype.callApi = function callApi(path, httpMethod, pathParams,
    ...
    if (pathParams && pathParams['repository_name']) {
      pathParams['repository_name'] = encodeURIComponent(pathParams['repository_name']);
    }
    var _this = this;
