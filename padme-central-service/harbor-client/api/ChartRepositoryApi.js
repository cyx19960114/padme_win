...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.HarborApi.ChartRepositoryApi = factory(root.HarborApi.ApiClient, root.HarborApi.Label);
  }
}(this, function(ApiClient, Label) {
  'use strict';

  /**
   * ChartRepository service.
   * @module api/ChartRepositoryApi
   * @version 2.0
   */

  /**
   * Constructs a new ChartRepositoryApi. 
   * @alias module:api/ChartRepositoryApi
   * @class
  ...
  var exports = function(apiClient) {
     ...
     * @callback module:api/ChartRepositoryApi~chartrepoRepoChartsNameVersionLabelsGetCallback
     ...
     * @param {module:api/ChartRepositoryApi~chartrepoRepoChartsNameVersionLabelsGetCallback} callback The callback function, accepting three arguments: error, data, response
     */
     ...
     * @callback module:api/ChartRepositoryApi~chartrepoRepoChartsNameVersionLabelsIdDeleteCallback
     * @param {String} error Error message, if any.
     * @param data This operation does not return a value.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:api/ChartRepositoryApi~chartrepoRepoChartsNameVersionLabelsIdDeleteCallback} callback The callback function, accepting three arguments: error, data, response
     */
     ...
     * @callback module:api/ChartRepositoryApi~chartrepoRepoChartsNameVersionLabelsPostCallback
     * @param {String} error Error message, if any.
     * @param data This operation does not return a value.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:api/ChartRepositoryApi~chartrepoRepoChartsNameVersionLabelsPostCallback} callback The callback function, accepting three arguments: error, data, response
     */
