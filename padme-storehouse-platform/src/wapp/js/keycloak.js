(function (global, factory) {
  typeof exports === "object" && typeof module !== "undefined"
    ...
    ? define("keycloak", ["crypto", "buffer"], factory)
    : ((global =
        typeof globalThis !== "undefined" ? globalThis : global || self),
      (global.Keycloak = factory(global.require$$0, global.require$$1)));
  ...
  (function (module, exports) {
    !(function (t, e) {
      ...
      function D() {
        var t = void 0;
        if ("undefined" != typeof commonjsGlobal) t = commonjsGlobal;
      ...
      R = I
        ...
        : J
        ? u()
        : void 0 === B && "function" == typeof commonjsRequire
        ? f()
        : c();
  ...
  (function (module) {
    ...
    (function () {
      ...
      var COMMON_JS =
        !root.JS_SHA256_NO_COMMON_JS && "object" === "object" && module.exports;
      var ARRAY_BUFFER =
  ...
  function Keycloak(config) {
    ...
    function applyTimeoutToPromise(promise, timeout, errorMessage) {
      ...
      var timeoutPromise = new es6Promise_minExports.Promise(function (
        resolve,
        reject
      ) {
      ...
      return es6Promise_minExports.Promise.race([
        promise,
        timeoutPromise,
      ]).finally(function () {
